...
with open('./WikipediaList/Sportifs/Liste_Basketteurs.json', encoding='utf-8') as json_file:
            ...
            if response is not None:
                ...
                if len(infobox_v2) > 0:
                    ...
                    if create == 'post':  # post article directly on the site
                        ...
                        postTags = [nationalite, 'Basket', 'Sport', name,
                                    'BasketBall', 'Basket Game', '2020']  # tags of the post
                        # Categories of the post
                        postCategories = [
                            nationalite, 'Basket', 'Sport', '2020', 'BasketBall', 'Basket Game']
